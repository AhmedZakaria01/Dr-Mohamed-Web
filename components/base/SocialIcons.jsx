/**
 * Inline brand marks for the 4 real social links — lucide-react v1 dropped
 * all brand/social icons, so these are hand-rolled minimal SVGs.
 */
...
export function LinkedinIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M6.94 8.5H3.56V21h3.38V8.5ZM5.25 3a1.97 1.97 0 1 0 0 3.94 1.97 1.97 0 0 0 0-3.94ZM21 21h-3.37v-6.06c0-1.44-.03-3.3-2.01-3.3-2.01 0-2.32 1.57-2.32 3.2V21H9.93V8.5h3.24v1.71h.05c.45-.86 1.56-1.78 3.21-1.78 3.44 0 4.07 2.26 4.07 5.21V21Z" />
    </svg>
  );
}
